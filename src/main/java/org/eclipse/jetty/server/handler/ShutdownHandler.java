...
/**
 * A handler that shuts the org.eclipse.jetty.server down on a valid request. Used to do "soft" restarts from Java. If _exitJvm ist set to true a hard System.exit() call is being
 * made.
 *
 ...
 *
 * <pre>
    Server org.eclipse.jetty.server = new Server(8080);
    HandlerList handlers = new HandlerList();
    handlers.setHandlers(new Handler[]
    { someOtherHandler, new ShutdownHandler(&quot;secret password&quot;) });
    org.eclipse.jetty.server.setHandler(handlers);
 ...
 *
   ...
   public static void attemptShutdown(int port, String shutdownCookie) {
        try {
            ...
            // Okay - the org.eclipse.jetty.server is not running
        } catch (IOException e) {
...
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.handler.ShutdownHandler.class);
    ...
    /**
     * Creates a listener that lets the org.eclipse.jetty.server be shut down remotely (but only from localhost).
     *
     * @param server
     ...
     * this org.eclipse.jetty.server with an identically configured ShutdownHandler
     */
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        new Thread()
        {
            ...
            public void run ()
            {
                ...
                {
                    throw new RuntimeException("Shutting down org.eclipse.jetty.server",e);
                }
            }
        }.start();
    }
