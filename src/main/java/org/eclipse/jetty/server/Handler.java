 ...
 *
 * A Handler instance is required by a {@link org.eclipse.jetty.server.Server} to handle incoming
 * HTTP requests.  A Handler may: <ul>
 * <li>Completely generate the HTTP Response</li>
 * <li>Examine/modify the request and call another Handler (see {@link org.eclipse.jetty.server.handler.HandlerWrapper}).
 * <li>Pass the request to one or more other Handlers (see {@link org.eclipse.jetty.server.handler.HandlerCollection}).
 * </ul>
 *
...
public interface Handler extends LifeCycle, Destroyable
{
     ...
     * object or a wrapper of that request. The {@link org.eclipse.jetty.server.HttpChannel#getCurrentHttpChannel()}
    ...
    @ManagedAttribute(value="the jetty org.eclipse.jetty.server for this handler", readonly=true)
