 ...
 * <ul>
 *
 * <li>The {@link org.eclipse.jetty.server.Request#getContextPath()} method will return null, until the request has been passed to a {@link org.eclipse.jetty.server.handler.ContextHandler} which matches the
 * {@link org.eclipse.jetty.server.Request#getPathInfo()} with a context path and calls {@link org.eclipse.jetty.server.Request#setContextPath(String)} as a result.</li>
 *
 ...
 *
 * <li>The {@link org.eclipse.jetty.server.Request#getServletPath()} method will return null until the request has been passed to a <code>org.eclipse.jetty.servlet.ServletHandler</code>
 * and the pathInfo matched against the servlet URL patterns and {@link org.eclipse.jetty.server.Request#setServletPath(String)} called as a result.</li>
 * </ul>
 *
 * A request instance is created for each connection accepted by the org.eclipse.jetty.server and recycled for each HTTP request received via that connection.
 ...
 * {@link org.eclipse.jetty.server.handler.ContextHandler#getMaxFormContentSize()} or if there is no context then the "org.eclipse.jetty.org.eclipse.jetty.server.Request.maxFormContentSize" {@link org.eclipse.jetty.server.Server}
 * attribute. The number of parameters keys is limited by {@link org.eclipse.jetty.server.handler.ContextHandler#getMaxFormKeys()} or if there is no context then the
 * "org.eclipse.jetty.org.eclipse.jetty.server.Request.maxFormKeys" {@link org.eclipse.jetty.server.Server} attribute.
 *
 *
 */
public class Request implements HttpServletRequest
{
    ...
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.Request.class);
    ...
    /* ------------------------------------------------------------ */
    public Request(HttpChannel<?> channel, org.eclipse.jetty.server.HttpInput<?> input)
    {
        _channel = channel;
        _input = input;
    }
                    ...
                    (HttpMethod.POST.is(getMethod()) || HttpMethod.PUT.is(getMethod())))
                {
                    ...
                    if (content_length != 0)
                    {
                        try
                        {
                            ...
                            {
                                Object obj = _channel.getServer().getAttribute("org.eclipse.jetty.org.eclipse.jetty.server.Request.maxFormContentSize");
                                if (obj == null)
                            ...
                            if (maxFormKeys < 0)
                            {
                                Object obj = _channel.getServer().getAttribute("org.eclipse.jetty.org.eclipse.jetty.server.Request.maxFormKeys");
                                if (obj == null)
                                    maxFormKeys = 1000;
                                else if (obj instanceof Number)
                                {
     ...
     * <dl>
     * <dt>org.eclipse.jetty.org.eclipse.jetty.server.Server</dt><dd>The Jetty Server instance</dd>
     * <dt>org.eclipse.jetty.org.eclipse.jetty.server.HttpChannel</dt><dd>The HttpChannel for this request</dd>
     * <dt>org.eclipse.jetty.org.eclipse.jetty.server.HttpConnection</dt><dd>The HttpConnection or null if another transport is used</dd>
     * </dl>
    ...
    public Object getAttribute(String name)
    {
        ...
        {
            if ("org.eclipse.jetty.org.eclipse.jetty.server.Server".equals(name))
                return _channel.getServer();
            if ("org.eclipse.jetty.org.eclipse.jetty.server.HttpChannel".equals(name))
                return _channel;
            if ("org.eclipse.jetty.org.eclipse.jetty.server.HttpConnection".equals(name) &&
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return The current {@link org.eclipse.jetty.server.handler.ContextHandler.Context context} used for this request, or <code>null</code> if {@link #setContext} has not yet been called.
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * Access the underlying Remote {@link java.net.InetSocketAddress} for this request.
     *
     * @return the remote {@link java.net.InetSocketAddress} for this request, or null if the request has no remote (see {@link ServletRequest#getRemoteAddr()} for
    ...
    /* ------------------------------------------------------------ */
    /**
     * Reconstructs the URL the client used to make the request. The returned URL contains a protocol, org.eclipse.jetty.server name, port number, and, but it does not include a
     * path.
     * <p>
    ...
    /* ------------------------------------------------------------ */
    /*
     * Set a request attribute. if the attribute name is "org.eclipse.jetty.org.eclipse.jetty.server.org.eclipse.jetty.server.Request.queryEncoding" then the value is also passed in a call to
    ...
    public void setAttribute(String name, Object value)
    {
        ...
        if ("org.eclipse.jetty.org.eclipse.jetty.server.Request.queryEncoding".equals(name))
            setQueryEncoding(value == null?null:value.toString());
        else if ("org.eclipse.jetty.org.eclipse.jetty.server.sendContent".equals(name))
            LOG.warn("Deprecated: org.eclipse.jetty.org.eclipse.jetty.server.sendContent");
     ...
     *
     * The request attribute "org.eclipse.jetty.org.eclipse.jetty.server.org.eclipse.jetty.server.Request.queryEncoding" may be set as an alternate method of calling setQueryEncoding.
     *
     * @param queryEncoding
     */
