...
public interface NetworkTrafficListener
{
     ...
     * However, the {@code socket} parameter is the same object passed to {@link #opened(java.net.Socket)},
     * so it is possible to map socket information in {@link #opened(java.net.Socket)} and retrieve it
     * in this method.
     *
