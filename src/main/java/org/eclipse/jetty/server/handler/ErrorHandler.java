 ...
 * An ErrorHandler is registered with {@link org.eclipse.jetty.server.handler.ContextHandler#setErrorHandler(org.eclipse.jetty.server.handler.ErrorHandler)} or
 * {@link org.eclipse.jetty.server.Server#addBean(Object)}.
 * It is called by the HttpResponse.sendError method to write a error page via {@link #handle(String, org.eclipse.jetty.server.Request, HttpServletRequest, HttpServletResponse)}
 * or via {@link #badMessageError(int, String, HttpFields)} for bad requests for which a dispatch cannot be done.
 *
 */
public class ErrorHandler extends AbstractHandler
{    
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.handler.ErrorHandler.class);
    public final static String ERROR_PAGE="org.eclipse.jetty.org.eclipse.jetty.server.error_page";
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty.org.eclipse.jetty.server.org.eclipse.jetty.server.Handler#handle(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, int)
     */
    @Override
