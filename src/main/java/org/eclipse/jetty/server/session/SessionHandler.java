...
{
    final static Logger LOG = Log.getLogger("org.eclipse.jetty.org.eclipse.jetty.server.session");
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty.org.eclipse.jetty.server.Handler#handle(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, int)
     */
    @Override
