...
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.HttpChannel.class);
    private static final ThreadLocal<org.eclipse.jetty.server.HttpChannel<?>> __currentChannel = new ThreadLocal<>();

    public static org.eclipse.jetty.server.HttpChannel<?> getCurrentHttpChannel()
    {
        return __currentChannel.get();
    }

    protected static org.eclipse.jetty.server.HttpChannel<?> setCurrentHttpChannel(org.eclipse.jetty.server.HttpChannel<?> channel)
    {
        org.eclipse.jetty.server.HttpChannel<?> last=__currentChannel.get();
        if (channel==null)
     ...
     *
     * @throws java.io.IOException if the InputStream cannot be created
     */
    ...
    public boolean handle()
    {
        ...
        final org.eclipse.jetty.server.HttpChannel<?> last = setCurrentHttpChannel(this);
     ...
     * bypassing the {@link org.eclipse.jetty.server.handler.ErrorHandler} mechanisms and the response OutputStream.</p>
     *
