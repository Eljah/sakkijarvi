 ...
 * Jetty org.eclipse.jetty.server over TCP/IP.  By the use of various {@link org.eclipse.jetty.server.ConnectionFactory} instances it is able
 ...
 * use all the commons services (eg {@link java.util.concurrent.Executor}, {@link Scheduler})  of the
 ...
 * <p>
 * <h2>Selectors</h2>
 * The connector will use the {@link java.util.concurrent.Executor} service to execute a number of Selector Tasks,
 * which are implemented to each use a NIO {@link java.nio.channels.Selector} instance to asynchronously
 ...
 * {@link java.util.concurrent.Executor} service any blocking, long running or application tasks.
 * <p>
...
public class ServerConnector extends AbstractNetworkConnector
{
    ...
    public ServerConnector(
        @Name("org/eclipse/jetty/server") Server server)
    {
     ...
     * @param server
     *          The org.eclipse.jetty.server this connector will be accept connection for.
     * @param executor
     ...
     * then it will fall back using {@link java.nio.channels.ServerSocketChannel}.</p>
    ...
    /**
     * @return whether the org.eclipse.jetty.server socket reuses addresses
    ...
    /**
     * @param reuseAddress whether the org.eclipse.jetty.server socket reuses addresses
    ...
    private final class ServerConnectorManager extends SelectorManager
    {
        ...
        {
            org.eclipse.jetty.server.ServerConnector.this.accepted(channel);
        }

        @Override
        protected SelectChannelEndPoint newEndPoint(SocketChannel channel, ManagedSelector selectSet, SelectionKey selectionKey) throws IOException
        {
            return org.eclipse.jetty.server.ServerConnector.this.newEndPoint(channel, selectSet, selectionKey);
        }

        @Override
        public Connection newConnection(SocketChannel channel, EndPoint endpoint, Object attachment) throws IOException
        {
            return getDefaultConnectionFactory().newConnection(org.eclipse.jetty.server.ServerConnector.this, endpoint);
        }
