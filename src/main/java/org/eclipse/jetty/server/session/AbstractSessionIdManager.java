...
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.session.AbstractSessionIdManager.class);

    private final static String __NEW_SESSION_ID="org.eclipse.jetty.org.eclipse.jetty.server.newSessionId";
     ...
     * @param reseed  If non zero then when a random long modulo the reseed value == 1, the {@link java.security.SecureRandom} will be reseeded.
     */
