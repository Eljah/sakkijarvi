...
public class HttpConfiguration
{
    ...
    {
        public void customize(Connector connector, org.eclipse.jetty.server.HttpConfiguration channelConfig, Request request);
    }
     ...
     */
    public HttpConfiguration(org.eclipse.jetty.server.HttpConfiguration config)
    {
     ...
     * optional protocol semantics (eg {@link org.eclipse.jetty.server.SecureRequestCustomizer}).
     ...
     * request received.</p>
     * <p>Customisers are often used to interpret optional headers (eg {@link org.eclipse.jetty.server.ForwardedRequestCustomizer}) or
     * optional protocol semantics (eg {@link org.eclipse.jetty.server.SecureRequestCustomizer}).
     * @param customizers
     */
     ...
     * in a URL. However, larger headers consume more memory and can make a org.eclipse.jetty.server more vulnerable to denial of service
     * attacks.</p>
