...
public class JpegEncoder extends Frame
{
    ...
    public static void main(String[] args)
    {
        ...
        JpegEncoder jpen=new JpegEncoder(outputImage, 80, out);
            jpen.Compress();
        try {

            FileOutputStream fos = new FileOutputStream(new File("outputtest2.jpeg"));
...
// library.
 ...
 /*
 * DCTRTP - A Java implementation of the Discreet Cosine Transform
 */

class DCT
{
    /**
     * DCTRTP Block Size - default 8
     */
    public int N        = 8;
    ...
    /**
     * Constructs a new DCTRTP object. Initializes the cosine transform matrix
     * these are used when computing the DCTRTP and it's inverse. This also
...
// quantum and Divisors are objects used to hold the appropriate matices
    ...
    /*
     * This method preforms forward DCTRTP on a block of image data using
...
// needs some tweaking.  If you get this part working, please let me know.
    ...
    /*
     * This method preforms a DCTRTP on a block of image data using the AAN
...
//                        outputData[index] = (int)(((inputData[i][j] * (((double[]) (Divisors[code]))[index])) + 16384.5) -16384);
    ...
    /*
    * This is the method for quantizing a block DCTRTP'ed with forwardDCTExtreme
    * This method quantitizes data and rounds it to the nearest integer.
    */
...
// It now incorporates HuffmanRTP table derivation as in the C jpeg library
...
class Huffman
{
    ...
    /*
    * The HuffmanRTP class constructor
    */
    ...
    /**
     * HuffmanBlockEncoder run length encodes and HuffmanRTP encodes the quantized
     * data.
     **/
...
// Uses an integer long (32 bits) buffer to store the HuffmanRTP encoded bits
// and sends them to outStream by the byte.
    ...
    /*
    * Initialisation of the HuffmanRTP codes for Luminance and Chrominance.
...
/*
 * JpegInfoRTP - Given an image, sets default information about it and divides
