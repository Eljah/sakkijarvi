...
/**
 * <p>{@link org.eclipse.jetty.server.Response} provides the implementation for {@link HttpServletResponse}.</p>
 */
public class Response implements HttpServletResponse
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.Response.class);
    ...
    /* ------------------------------------------------------------ */
    public static org.eclipse.jetty.server.Response getResponse(HttpServletResponse response)
    {
        if (response instanceof org.eclipse.jetty.server.Response)
            return (org.eclipse.jetty.server.Response)response;
     ...
     */
    public final static String SET_INCLUDE_HEADER_PREFIX = "org.eclipse.jetty.org.eclipse.jetty.server.include.";
    ...
    {
        org.eclipse.jetty.server.Response response = _channel.getResponse();
