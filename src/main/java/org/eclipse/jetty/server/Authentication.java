...
public interface Authentication
{
     ...
     */
    public interface User extends org.eclipse.jetty.server.Authentication
    {
     ...
     */
    public interface Wrapped extends org.eclipse.jetty.server.Authentication
    {
     ...
     */
    public interface Deferred extends org.eclipse.jetty.server.Authentication
    {
        /* ------------------------------------------------------------ */
         ...
         */
        org.eclipse.jetty.server.Authentication authenticate(ServletRequest request);
         ...
         * @return The new Authentication state.
         */
        org.eclipse.jetty.server.Authentication authenticate(ServletRequest request, ServletResponse response);
         ...
         * @return The new Authentication state
         */
        org.eclipse.jetty.server.Authentication login(String username, Object password, ServletRequest request);
    }
     ...
     */
    public interface ResponseSent extends org.eclipse.jetty.server.Authentication
    { 
    }
     ...
     */
    public final static org.eclipse.jetty.server.Authentication UNAUTHENTICATED = new org.eclipse.jetty.server.Authentication(){@Override
     ...
     */
    public final static org.eclipse.jetty.server.Authentication NOT_CHECKED = new org.eclipse.jetty.server.Authentication(){@Override
     ...
     */
    public final static org.eclipse.jetty.server.Authentication SEND_CONTINUE = new org.eclipse.jetty.server.Authentication.Challenge(){@Override
     ...
     */
    public final static org.eclipse.jetty.server.Authentication SEND_FAILURE = new org.eclipse.jetty.server.Authentication.Failure(){@Override
    public String toString(){return "FAILURE";}};
    public final static org.eclipse.jetty.server.Authentication SEND_SUCCESS = new SendSuccess(){@Override
