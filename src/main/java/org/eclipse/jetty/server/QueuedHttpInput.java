...
/**
 * {@link org.eclipse.jetty.server.QueuedHttpInput} holds a queue of items passed to it by calls to {@link #content(Object)}.
 * <p/>
 * {@link org.eclipse.jetty.server.QueuedHttpInput} stores the items directly; if the items contain byte buffers, it does not copy them
...
{
    private final static Logger LOG = Log.getLogger(org.eclipse.jetty.server.QueuedHttpInput.class);
