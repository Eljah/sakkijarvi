 ...
 * set as the "org.eclipse.jetty.org.eclipse.jetty.server.session.timer" attribute of the ContextHandler.
 *
 */
public class HashSessionManager extends AbstractSessionManager
{
    ...
    public void doStart() throws Exception
    {
        ...
        if (_timer == null)
        {
            ...
            if (context!=null)
                _timer = (Scheduler)context.getAttribute("org.eclipse.jetty.org.eclipse.jetty.server.session.timer");
        }
