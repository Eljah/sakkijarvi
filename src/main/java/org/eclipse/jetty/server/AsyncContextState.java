...
{
    volatile org.eclipse.jetty.server.HttpChannelState _state;

    public AsyncContextState(org.eclipse.jetty.server.HttpChannelState state)
    {
        _state=state;
    }
    ...
    {
        org.eclipse.jetty.server.HttpChannelState state=_state;
        if (state==null)
