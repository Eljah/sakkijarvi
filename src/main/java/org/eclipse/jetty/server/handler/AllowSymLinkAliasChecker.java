 ...
 * <p>An instance of this class can be registered with {@link org.eclipse.jetty.server.handler.ContextHandler#addAliasCheck(org.eclipse.jetty.server.handler.ContextHandler.AliasCheck)}
 * to check resources that are aliased to other locations.   The checker uses the
 * Java {@link java.nio.file.Files#readSymbolicLink(java.nio.file.Path)} and {@link java.nio.file.Path#toRealPath(java.nio.file.LinkOption...)}
 * APIs to check if a file is aliased with symbolic links.</p>
 */
public class AllowSymLinkAliasChecker implements AliasCheck
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.handler.AllowSymLinkAliasChecker.class);
