...
/**
 * This {@link org.eclipse.jetty.server.RequestLog} implementation outputs logs in the pseudo-standard
...
public class NCSARequestLog extends AbstractNCSARequestLog implements RequestLog
{
     ...
     * @see RolloverFileOutputStream#RolloverFileOutputStream(String, boolean, int, java.util.TimeZone, String, String)
     *
