...
/**
 * Implementation of NCSARequestLog where output is sent as a SLF4J INFO Log message on the named logger "org.eclipse.jetty.org.eclipse.jetty.server.RequestLog"
 */
...
public class Slf4jRequestLog extends AbstractNCSARequestLog implements RequestLog
{
    ...
    public Slf4jRequestLog()
    {
        ...
        this.loggerName = "org.eclipse.jetty.org.eclipse.jetty.server.RequestLog";
    }
