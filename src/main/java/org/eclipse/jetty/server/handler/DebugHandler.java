...
public class DebugHandler extends HandlerWrapper implements Connection.Listener
{
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty.org.eclipse.jetty.server.Handler#handle(java.lang.String, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.jetty.org.eclipse.jetty.server.handler.HandlerWrapper#doStart()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.jetty.org.eclipse.jetty.server.handler.HandlerWrapper#doStop()
     */
    @Override
