 ...
 * </ul>
 * <p>If these headers are present, then the {@link org.eclipse.jetty.server.Request} object is updated
...
public class ForwardedRequestCustomizer implements Customizer
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return the header name for forwarded org.eclipse.jetty.server.
     */
     ...
     *            The header name for forwarded org.eclipse.jetty.server (default x-forwarded-org.eclipse.jetty.server)
     */
    ...
    public void customize(Connector connector, HttpConfiguration config, Request request)
    {
        ...
        {
            // Use provided org.eclipse.jetty.server name
