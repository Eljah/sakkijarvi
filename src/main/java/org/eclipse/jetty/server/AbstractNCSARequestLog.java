...
/**
 * Base implementation of the {@link org.eclipse.jetty.server.RequestLog} outputs logs in the pseudo-standard NCSA common log format.
...
{
    protected static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.AbstractNCSARequestLog.class);
    ...
    /**
     * @deprecated use {@link org.eclipse.jetty.server.handler.StatisticsHandler}
     */
