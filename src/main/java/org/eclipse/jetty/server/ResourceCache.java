...
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.ResourceCache.class);
     ...
     */
    public ResourceCache(org.eclipse.jetty.server.ResourceCache parent, ResourceFactory factory, MimeTypes mimeTypes,boolean useFileMappedBuffer,boolean etags)
    {
        _factory = factory;
     ...
     * @throws java.io.IOException Problem loading the resource
     */
    ...
    public class Content implements HttpContent
    {
        ...
        Content(String pathInContext,Resource resource)
        {
            ...
            _etag= org.eclipse.jetty.server.ResourceCache.this._etagSupported?resource.getWeakETag():null;
        }
        ...
        public ByteBuffer getIndirectBuffer()
        {
            ...
            if (buffer==null)
            {
                ByteBuffer buffer2= org.eclipse.jetty.server.ResourceCache.this.getIndirectBuffer(_resource);
        ...
        public ByteBuffer getDirectBuffer()
        {
            ...
            if (buffer==null)
            {
                ByteBuffer buffer2= org.eclipse.jetty.server.ResourceCache.this.getDirectBuffer(_resource);
