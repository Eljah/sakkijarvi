 ...
 * This org.eclipse.jetty.org.eclipse.jetty.servlet invokes anonymous servlets that have not been defined
 * in the web.xml or by other means. The first element of the pathInfo
 * of a request passed to the envoker is treated as a org.eclipse.jetty.org.eclipse.jetty.servlet name for
 * an existing org.eclipse.jetty.org.eclipse.jetty.servlet, or as a class name of a new org.eclipse.jetty.org.eclipse.jetty.servlet.
 * This org.eclipse.jetty.org.eclipse.jetty.servlet is normally mapped to /org.eclipse.jetty.org.eclipse.jetty.servlet/*
 * This org.eclipse.jetty.org.eclipse.jetty.servlet support the following initParams:
 * <PRE>
 ...
 *                           each dynamic org.eclipse.jetty.org.eclipse.jetty.servlet as init parameters
 * </PRE>
...
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.servlet.Invoker.class);
    ...
    public void init()
    {
        ...
        while (handler!=null && !(handler instanceof org.eclipse.jetty.servlet.ServletHandler) && (handler instanceof HandlerWrapper))
	...
	throws ServletException, IOException
    {
        ...
        // Get the org.eclipse.jetty.org.eclipse.jetty.servlet class
        ...
        if (holder!=null)
        {
            // Found a named org.eclipse.jetty.org.eclipse.jetty.servlet (from a user's web.xml file) so
            // now we add a mapping for it
            if (LOG.isDebugEnabled())
                LOG.debug("Adding org.eclipse.jetty.org.eclipse.jetty.servlet mapping for named org.eclipse.jetty.org.eclipse.jetty.servlet:"+servlet+":"+URIUtil.addPaths(servlet_path,servlet)+"/*");
        ...
        else
        {
            ...
            synchronized(_servletHandler)
            {
                ...
                else
                {
                    // Make a holder
                    if (LOG.isDebugEnabled())
                        LOG.debug("Making new org.eclipse.jetty.org.eclipse.jetty.servlet="+servlet+" with path="+path+"/*");
                    ...
                    if (!_nonContextServlets)
                    {
                            ...
                            s.getClass().getClassLoader())
                        {
                            ...
                            LOG.warn("Dynamic org.eclipse.jetty.org.eclipse.jetty.servlet "+s+
        ...
        {
            LOG.info("Can't find holder for org.eclipse.jetty.org.eclipse.jetty.servlet: "+servlet);
            response.sendError(404);
        }
