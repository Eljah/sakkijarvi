...
public class RTCPSession {
	 ...
	 */
	public RTCPSession(RTPSession parent, DatagramSocket rtcpSocket) {
		this.rtcpSock = rtcpSocket;
		rtpSession = parent;
        start(); //todo check is it okay
	}
    ...
    synchronized public void addToQueue(long targetSsrc, RtcpPktAPP aPkt) {
        aPkt.time = System.currentTimeMillis();
