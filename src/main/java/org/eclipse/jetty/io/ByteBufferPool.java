...
/**
 * <p>A {@link java.nio.ByteBuffer} pool.</p>
 * <p>Acquired buffers may be {@link #release(java.nio.ByteBuffer) released} but they do not need to;
...
{
    /**
     * <p>Requests a {@link java.nio.ByteBuffer} of the given size.</p>
     ...
     * @see #release(java.nio.ByteBuffer)
     */
    public ByteBuffer acquire(int size, boolean direct);

    /**
     * <p>Returns a {@link java.nio.ByteBuffer}, usually obtained with {@link #acquire(int, boolean)}
