...
public abstract class SelectorManager extends AbstractLifeCycle implements Dumpable
{
     ...
     * <p>The channel must be set in non-blocking mode, and {@link java.nio.channels.SocketChannel#connect( java.net.SocketAddress)}
     ...
     * <p>This method is called just after a channel has been accepted by {@link java.nio.channels.ServerSocketChannel#accept()},
     * or just after having performed a blocking connect via {@link java.net.Socket#connect( java.net.SocketAddress, int)}.</p>
     *
     * @param channel the channel to register
     */
     ...
     * When a {@link java.nio.channels.SocketChannel} is accepted from the given {@link java.nio.channels.ServerSocketChannel}
     * then the {@link #accepted( java.nio.channels.SocketChannel)} method is called, which must be
    ...
    /**
     * Callback method when a channel is accepted from the {@link java.nio.channels.ServerSocketChannel}
     * passed to {@link #acceptor( java.nio.channels.ServerSocketChannel)}.
     ...
     * <p>This method is invoked as a result of the registration of a channel via {@link #connect( java.nio.channels.SocketChannel, Object)}
     * or {@link #accept( java.nio.channels.SocketChannel)}.</p>
     *
     * @param channel   the channel associated to the endpoint
     * @param selector the selector the channel is registered to
     * @param selectionKey      the selection key
     * @return a new endpoint
     * @throws java.io.IOException if the endPoint cannot be created
     * @see #newConnection( java.nio.channels.SocketChannel, EndPoint , Object)
     */
     ...
     * @throws java.io.IOException
     * @see #newEndPoint( java.nio.channels.SocketChannel, ManagedSelector, java.nio.channels.SelectionKey)
     */
    ...
    /**
     * <p>{@link ManagedSelector} wraps a {@link java.nio.channels.Selector} simplifying non-blocking operations on channels.</p>
     * <p>{@link ManagedSelector} runs the select loop, which waits on {@link java.nio.channels.Selector#select()} until events
    ...
    public class ManagedSelector extends AbstractLifeCycle implements Runnable, Dumpable
    {
        ...
        /**
         * <p>Process changes and waits on {@link java.nio.channels.Selector#select()}.</p>
         *
         * @see #submit(Runnable)
         */
        public void select()
