...
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.servlet.StatisticsServlet.class);
    ...
    private boolean isLoopbackAddress(String address)
    {
        ...
        {
            LOG.warn("Warning: attempt to access statistics org.eclipse.jetty.org.eclipse.jetty.servlet from " + address, e);
            return false;
        }
    }
