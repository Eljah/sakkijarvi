...
public interface UserIdentity
{
    ...
    /* ------------------------------------------------------------ */
    public interface UnauthenticatedUserIdentity extends org.eclipse.jetty.server.UserIdentity
    {
    }

    /* ------------------------------------------------------------ */
    public static final org.eclipse.jetty.server.UserIdentity UNAUTHENTICATED_IDENTITY = new UnauthenticatedUserIdentity()
    {
