 ...
 * passed in the {@link #parseNext( java.nio.ByteBuffer)} method.  The parsed
 ...
 * true then the call to {@link #parseNext( java.nio.ByteBuffer)} will return as
 ...
 * should be done after a true return from {@link #parseNext( java.nio.ByteBuffer)}
 ...
 * {@link Trie#getBest( java.nio.ByteBuffer, int, int)} method to look ahead in a
                    ...
                    switch(ch)
                    {
                        ...
                        default:
                        {
                            ...
                            if (ch == HttpTokens.LINE_FEED)
                            {
                                ...
                                if (!_host && (_version!=HttpVersion.HTTP_1_0  && _version!=HttpVersion.RTSP_1_0) && _requestHandler!=null)
                                {
