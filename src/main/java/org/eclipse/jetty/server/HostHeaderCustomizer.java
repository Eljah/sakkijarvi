 ...
 * header; if the {@code Host} header is missing, the org.eclipse.jetty.server may query the connector for its
 * IP address in order to construct the {@code Location} header, and thus leak to clients
 * internal IP addresses.
 * <p />
 * This {@link org.eclipse.jetty.server.HttpConfiguration.Customizer} is configured with a {@code serverName} and
