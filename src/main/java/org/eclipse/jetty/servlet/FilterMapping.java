...
public class FilterMapping implements Dumpable
{
     ...
     */
    @ManagedAttribute(value="org.eclipse.jetty.org.eclipse.jetty.servlet names", readonly=true)
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param servletName Maps the {@link #setFilterName(String) named filter} to a single org.eclipse.jetty.org.eclipse.jetty.servlet
     * @see #setServletNames
     */
