 ...
 * and another consumer of an EndPoint (typically an {@link org.eclipse.jetty.io.Connection} like HttpConnection) that
 * wants unencrypted data.
 * <p>
 * The connector uses an {@link org.eclipse.jetty.io.EndPoint} (typically {@link org.eclipse.jetty.io.SelectChannelEndPoint}) as
 ...
 * <p>
 * The passive methods are {@link DecryptedEndPoint#fill(java.nio.ByteBuffer)} and {@link DecryptedEndPoint#flush(java.nio.ByteBuffer...)}. They make best
 * effort attempts to progress the connection using only calls to the encrypted {@link org.eclipse.jetty.io.EndPoint#fill(java.nio.ByteBuffer)} and {@link org.eclipse.jetty.io.EndPoint#flush(java.nio.ByteBuffer...)}
 ...
 * encrypted endpoint, but if insufficient bytes are read it will NOT call {@link org.eclipse.jetty.io.EndPoint#fillInterested(Callback)}.
 * <p>
 * It is only the active methods : {@link DecryptedEndPoint#fillInterested(Callback)} and
 * {@link DecryptedEndPoint#write(Callback, java.nio.ByteBuffer...)} that may schedule callbacks by calling the encrypted
 * {@link org.eclipse.jetty.io.EndPoint#fillInterested(Callback)} and {@link org.eclipse.jetty.io.EndPoint#write(Callback, java.nio.ByteBuffer...)}
