 ...
 * each define a scope.   
 * 
 * <p>When {@link #handle(String, org.eclipse.jetty.server.Request, HttpServletRequest, HttpServletResponse)}
 * is called on the first ScopedHandler in a chain of HandlerWrappers,
 * the {@link #doScope(String, org.eclipse.jetty.server.Request, HttpServletRequest, HttpServletResponse)} method is
 * called on all contained ScopedHandlers, before the
 * {@link #doHandle(String, org.eclipse.jetty.server.Request, HttpServletRequest, HttpServletResponse)} method
...
{
    private static final ThreadLocal<org.eclipse.jetty.server.handler.ScopedHandler> __outerScope= new ThreadLocal<org.eclipse.jetty.server.handler.ScopedHandler>();
    ...
    protected void doStart() throws Exception
    {
        try
        {
            ...
            _nextScope= getChildHandlerByClass(org.eclipse.jetty.server.handler.ScopedHandler.class);
