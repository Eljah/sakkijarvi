...
/** A <code>HandlerWrapper</code> acts as a {@link org.eclipse.jetty.server.Handler} but delegates the {@link org.eclipse.jetty.server.Handler#handle handle} method and
...
public class HandlerWrapper extends AbstractHandlerContainer
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param handler Set the {@link org.eclipse.jetty.server.Handler} which should be wrapped.
     */
