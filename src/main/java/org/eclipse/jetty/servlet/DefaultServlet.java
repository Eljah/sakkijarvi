...
/** The default org.eclipse.jetty.org.eclipse.jetty.servlet.
 * This org.eclipse.jetty.org.eclipse.jetty.servlet, normally mapped to /, provides the handling for static
 * content, OPTION and TRACE methods for the context.
 * The following initParameters are supported, these can be set either
 * on the org.eclipse.jetty.org.eclipse.jetty.servlet itself or as ServletContext initParameters with a prefix
 * of org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.servlet.Default. :
 * <PRE>
 ...
 *                    org.eclipse.jetty.org.eclipse.jetty.servlet matches are supported without an existing file.
 *                    Default is true.
 *
 ...
 *
 *  resourceCache     If set, this is a context attribute name, which the org.eclipse.jetty.org.eclipse.jetty.servlet
 *                    will use to look for a shared ResourceCache instance.
 *
 *  relativeResourceBase
 *                    Set with a pathname relative to the base of the
 *                    org.eclipse.jetty.org.eclipse.jetty.servlet context root. Useful for only serving static content out
...
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.servlet.DefaultServlet.class);
     ...
     * @param servletContext The servletContext of this org.eclipse.jetty.org.eclipse.jetty.servlet.
    ...
    {
        String value=getServletContext().getInitParameter("org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.servlet.Default."+name);
        if (value==null)
    ...
    throws ServletException, IOException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                if (!endsWithSlash || (pathInContext.length()==1 && request.getAttribute("org.eclipse.jetty.org.eclipse.jetty.server.nullPathInfo")!=null))
                {
                ...
                else if (null!=(welcome=getWelcomeFile(pathInContext)))
                {
                    ...
                    else
                    {
                        ...
                        if (dispatcher!=null)
                        {
                            ...
                            {
                                request.setAttribute("org.eclipse.jetty.org.eclipse.jetty.server.welcome",welcome);
    ...
    /* ------------------------------------------------------------ */
    /* (non-Javadoc)
     * @see javax.org.eclipse.jetty.org.eclipse.jetty.servlet.http.HttpServlet#doTrace(javax.org.eclipse.jetty.org.eclipse.jetty.servlet.http.HttpServletRequest, javax.org.eclipse.jetty.org.eclipse.jetty.servlet.http.HttpServletResponse)
     */
    @Override
     ...
     * If the resource is not a directory, or no matching file is found, then it may look for a valid org.eclipse.jetty.org.eclipse.jetty.servlet mapping.
     * If there is none, then <code>null</code> is returned.
     * The list of welcome files is read from the {@link ContextHandler} for this org.eclipse.jetty.org.eclipse.jetty.servlet, or
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.org.eclipse.jetty.org.eclipse.jetty.servlet.Servlet#destroy()
     */
    @Override
    public void destroy()
    {
