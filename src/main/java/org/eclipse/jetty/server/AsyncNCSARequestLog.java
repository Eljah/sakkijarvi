...
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.AsyncNCSARequestLog.class);
    ...
    private class WriterThread extends Thread
    {
        WriterThread()
        {
            setName("AsyncNCSARequestLog@"+Integer.toString(org.eclipse.jetty.server.AsyncNCSARequestLog.this.hashCode(),16));
        }
        ...
        public void run()
        {
            while (isRunning())
            {
                try
                {
                    ...
                    if (log!=null)
                        org.eclipse.jetty.server.AsyncNCSARequestLog.super.write(log);
