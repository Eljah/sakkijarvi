 ...
 * This class is the main class for the Jetty HTTP Servlet org.eclipse.jetty.server.
 * It aggregates Connectors (HTTP request receivers) and request Handlers.
 * The org.eclipse.jetty.server is itself a handler and a ThreadPool.  Connectors use the ThreadPool methods
 * to run jobs that will eventually call the handle method.
 */
@ManagedObject(value="Jetty HTTP Servlet org.eclipse.jetty.server")
public class Server extends HandlerWrapper implements Attributes
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.Server.class);
     ...
     * Creates org.eclipse.jetty.server and a {@link org.eclipse.jetty.server.ServerConnector} at the passed port.
    ...
    /* ------------------------------------------------------------ */
    /** Convenience constructor
     * Creates org.eclipse.jetty.server and a {@link org.eclipse.jetty.server.ServerConnector} at the passed address.
     */
    ...
    /* ------------------------------------------------------------ */
    @ManagedAttribute("version of this org.eclipse.jetty.server")
     ...
     */
    @ManagedAttribute(value="connectors for this org.eclipse.jetty.server", readonly=true)
    ...
    public void addConnector(Connector connector)
    {
        if (connector.getServer() != this)
            throw new IllegalArgumentException("Connector " + connector +
                    " cannot be shared among org.eclipse.jetty.server " + connector.getServer() + " and org.eclipse.jetty.server " + this);
    ...
    /* ------------------------------------------------------------ */
    /** Set the connectors for this org.eclipse.jetty.server.
     * Each connector has this org.eclipse.jetty.server set as it's ThreadPool and its Handler.
     ...
     */
    @ManagedAttribute("the org.eclipse.jetty.server thread pool")
    ...
    /* ------------------------------------------------------------ */
    /* Handle Options request to org.eclipse.jetty.server
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return The URI of the first {@link org.eclipse.jetty.server.NetworkConnector} and first {@link org.eclipse.jetty.server.handler.ContextHandler}, or null
     */
    public URI getURI()
    {
