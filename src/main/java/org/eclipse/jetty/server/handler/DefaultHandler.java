...
/** Default Handler.
 *
 * This handle will deal with unhandled requests in the org.eclipse.jetty.server.
...
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.handler.DefaultHandler.class);
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        writer.write("No context on this org.eclipse.jetty.server matched or handled this request.<BR>");
        writer.write("Contexts known to this org.eclipse.jetty.server are: <ul>");
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return Returns true if the handle can org.eclipse.jetty.server the jetty favicon.ico
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param serveIcon true if the handle can org.eclipse.jetty.server the jetty favicon.ico
     */
