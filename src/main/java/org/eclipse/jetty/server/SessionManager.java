...
public interface SessionManager extends LifeCycle
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Sets the {@link org.eclipse.jetty.server.session.SessionHandler}.
     *
     ...
     * @see #removeEventListener(java.util.EventListener)
     */
     ...
     * @see #addEventListener(java.util.EventListener)
     */
     ...
     * @param requestIsSecure whether the client is accessing the org.eclipse.jetty.server over a secure protocol (i.e. HTTPS).
     ...
     * @see #setSessionIdManager(org.eclipse.jetty.server.SessionIdManager)
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * Called by the {@link org.eclipse.jetty.server.session.SessionHandler} when a session is first accessed by a request.
     *
     * @param session the session object
    ...
    /* ------------------------------------------------------------ */
    /**
     * Called by the {@link org.eclipse.jetty.server.session.SessionHandler} when a session is last accessed by a request.
     *
     * @param session the session object
