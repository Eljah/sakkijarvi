 ...
 * AbstractHolder
 * 
 * Base class for all org.eclipse.jetty.org.eclipse.jetty.servlet-related classes that may be lazily instantiated  (eg org.eclipse.jetty.org.eclipse.jetty.servlet, filter,
...
public abstract class BaseHolder<T> extends AbstractLifeCycle implements Dumpable
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param servletHandler The {@link org.eclipse.jetty.servlet.ServletHandler} that will handle requests dispatched to this org.eclipse.jetty.org.eclipse.jetty.servlet.
     */
