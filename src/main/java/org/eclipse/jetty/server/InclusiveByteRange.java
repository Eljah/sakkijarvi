...
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.InclusiveByteRange.class);
     ...
     */
    public static List<org.eclipse.jetty.server.InclusiveByteRange> satisfiableRanges(Enumeration headers, long size)
    {
            ...
            try
            {
                ...
                while (tok.hasMoreTokens())
                {
                    try
                    {
                        ...
                        if (first < size)
                        {
                            org.eclipse.jetty.server.InclusiveByteRange range = new org.eclipse.jetty.server.InclusiveByteRange(first,last);
