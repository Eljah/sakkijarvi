...
public abstract class AbstractHandlerContainer extends AbstractHandler implements HandlerContainer
{
    ...
    protected void expandHandler(Handler handler, List<Handler> list, Class<?> byClass)
    {
        ...
        if (handler instanceof org.eclipse.jetty.server.handler.AbstractHandlerContainer)
            ((org.eclipse.jetty.server.handler.AbstractHandlerContainer)handler).expandChildren(list, byClass);
