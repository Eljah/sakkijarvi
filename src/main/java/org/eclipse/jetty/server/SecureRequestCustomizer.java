...
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.SecureRequestCustomizer.class);
    ...
    /* ------------------------------------------------------------ */
    /*
     * Allow the Listener a chance to customise the request. before the org.eclipse.jetty.server
     * does its stuff. <br>
