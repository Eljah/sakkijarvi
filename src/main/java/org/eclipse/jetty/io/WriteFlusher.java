...
/**
 * A Utility class to help implement {@link EndPoint#write(Callback, java.nio.ByteBuffer...)} by calling
 * {@link EndPoint#flush(java.nio.ByteBuffer...)} until all content is written.
...
abstract public class WriteFlusher
{
     ...
     * @throws java.nio.channels.WritePendingException if currentState is WRITING and new state is WRITING (api usage error)
     */
     ...
     * method when a call to {@link EndPoint#flush(java.nio.ByteBuffer...)} is likely to be able to progress.
     *
