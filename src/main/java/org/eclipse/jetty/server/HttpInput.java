...
/**
 * {@link org.eclipse.jetty.server.HttpInput} provides an implementation of {@link ServletInputStream} for {@link org.eclipse.jetty.server.HttpChannel}.
 * <p/>
...
{
    private final static Logger LOG = Log.getLogger(org.eclipse.jetty.server.HttpInput.class);

    private final byte[] _oneByteBuffer = new byte[1];
    private final Object _lock;
    private org.eclipse.jetty.server.HttpChannelState _channelState;
     ...
     * @throws java.io.IOException if retrieving the content fails
     */
     ...
     *
     * @throws java.io.IOException if the wait is interrupted
     */
    ...
    {
        public void waitForContent(org.eclipse.jetty.server.HttpInput<?> in) throws IOException
        {
        }
    ...
    {
        @Override
        public void waitForContent(org.eclipse.jetty.server.HttpInput<?> input) throws IOException
        {
