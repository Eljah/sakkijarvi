 ...
 * javax.org.eclipse.jetty.org.eclipse.jetty.servlet.http.HttpServlet API.
 * <P>
 ...
 * <p>
 * Unless run as part of a {@link org.eclipse.jetty.servlet.ServletContextHandler} or derivative, the {@link #initialize()}
 * method must be called manually after start().
 */
@ManagedObject("Servlet Handler")
public class ServletHandler extends ScopedHandler
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.servlet.ServletHandler.class);
    ...
    {
        //Don't start the whole object tree (ie all the org.eclipse.jetty.org.eclipse.jetty.servlet and filter Holders) when
        ...
        throws Exception
    {
        ...
        if (_servlets!=null)
        {
            for (int i=_servlets.length; i-->0;)
            {
                ...
                {
                    //remove from org.eclipse.jetty.org.eclipse.jetty.servlet name map
                    _servletNameMap.remove(_servlets[i].getName());
                    //remove any mappings associated with this org.eclipse.jetty.org.eclipse.jetty.servlet
    ...
    public void doScope(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        // find the org.eclipse.jetty.org.eclipse.jetty.servlet
        if (target.startsWith("/"))
        {
            // Look for the org.eclipse.jetty.org.eclipse.jetty.servlet by path
        ...
        {
            // look for a org.eclipse.jetty.org.eclipse.jetty.servlet by name!
            servlet_holder= _servletNameMap.get(target);
        }

        if (LOG.isDebugEnabled())
            LOG.debug("org.eclipse.jetty.org.eclipse.jetty.servlet {}|{}|{} -> {}",baseRequest.getContextPath(),baseRequest.getServletPath(),baseRequest.getPathInfo(),servlet_holder);
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty.org.eclipse.jetty.server.Handler#handle(javax.org.eclipse.jetty.org.eclipse.jetty.servlet.http.HttpServletRequest, javax.org.eclipse.jetty.org.eclipse.jetty.servlet.http.HttpServletResponse, int)
     */
    @Override
            ...
            for (ServletHolder servlet : servlets)
            {
                try
                {
                    if (servlet.getClassName() == null && servlet.getForcedPath() != null)
                    {
                        ...
                        {
                            mx.add(new IllegalStateException("No forced path org.eclipse.jetty.org.eclipse.jetty.servlet for " + servlet.getForcedPath()));
                            continue;
                        }
    ...
    /* ------------------------------------------------------------ */
    /** Convenience method to add a org.eclipse.jetty.org.eclipse.jetty.servlet.
     * @return The org.eclipse.jetty.org.eclipse.jetty.servlet holder.
     */
    ...
    /* ------------------------------------------------------------ */
    /** conveniance method to add a org.eclipse.jetty.org.eclipse.jetty.servlet.
     * @return The org.eclipse.jetty.org.eclipse.jetty.servlet holder.
     */
    ...
    /* ------------------------------------------------------------ */
    /** conveniance method to add a org.eclipse.jetty.org.eclipse.jetty.servlet.
     * @param servlet org.eclipse.jetty.org.eclipse.jetty.servlet holder to add
     * @param pathSpec org.eclipse.jetty.org.eclipse.jetty.servlet mappings for the servletHolder
     */
     ...
     * @param dispatches see {@link org.eclipse.jetty.servlet.FilterMapping#setDispatches(int)}
     ...
     * @deprecated use {@link #addFilterWithMapping(Class, String, java.util.EnumSet)} instead
     */
    ...
    protected synchronized void updateNameMappings()
    {
        ...
        // Map org.eclipse.jetty.org.eclipse.jetty.servlet names to holders
    ...
    protected synchronized void updateMappings()
    {
        ...
        // Map org.eclipse.jetty.org.eclipse.jetty.servlet paths to holders
        ...
        else
        {
            ...
            //evaluate path to org.eclipse.jetty.org.eclipse.jetty.servlet map based on org.eclipse.jetty.org.eclipse.jetty.servlet mappings
            for (String pathSpec : sms.keySet())
            {
                //for each path, look at the mappings where it is referenced
                //if a mapping is for a org.eclipse.jetty.org.eclipse.jetty.servlet that is not enabled, skip it
                Set<ServletMapping> mappings = sms.get(pathSpec);
                ...
                {
                    //Get org.eclipse.jetty.org.eclipse.jetty.servlet associated with the mapping and check it is enabled
                    ServletHolder servlet_holder = _servletNameMap.get(mapping.getServletName());
                    if (servlet_holder == null)
                        throw new IllegalStateException("No such org.eclipse.jetty.org.eclipse.jetty.servlet: " + mapping.getServletName());
                    //if the org.eclipse.jetty.org.eclipse.jetty.servlet related to the mapping is not enabled, skip it from consideration
                ...
                if (finalMapping == null)
                    throw new IllegalStateException ("No acceptable org.eclipse.jetty.org.eclipse.jetty.servlet mappings for "+pathSpec);

                if (LOG.isDebugEnabled()) LOG.debug("Chose path={} mapped to org.eclipse.jetty.org.eclipse.jetty.servlet={} from default={}", pathSpec, finalMapping.getServletName(), finalMapping.isDefault());
    ...
    private class CachedChain implements FilterChain
    {
        ...
        /* ------------------------------------------------------------ */
        /**
         * @param filters list of {@link org.eclipse.jetty.servlet.FilterHolder} objects
         * @param servletHolder
         */
            ...
            throws IOException, ServletException
        {
            ...
            // Call org.eclipse.jetty.org.eclipse.jetty.servlet

            HttpServletRequest srequest = (HttpServletRequest)request;
            if (_servletHolder != null)
            {
                if (LOG.isDebugEnabled())
                    LOG.debug("call org.eclipse.jetty.org.eclipse.jetty.servlet " + _servletHolder);
