...
public class SDP {
    ...
    public void setM(List<Media> in) {
        m=in;
    }
    ...
    protected void parseLine(String line) {
        ...
        } else if (line.substring(0, 2).equals("s=")) {
